...
# Création de l'environnement avec une gravité modifiée
...
# Remplacez "ppo_hacked_model.zip" par le nom réel de votre fichier sauvegardé
model = PPO.load("ppo_hacked_model.zip", device="cpu")
