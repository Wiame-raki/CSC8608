...
# Baseline neutre (image noire)
baseline = torch.zeros_like(input_tensor)

start_ig = time.time()

# Attribution IG (50 steps) avec limitation mémoire
...
# Envelopper IG dans NoiseTunnel
...
attributions_sg = noise_tunnel.attribute(
    ...
    nt_type='smoothgrad',
    target=predicted_class_idx,
    stdevs=0.1,              # amplitude du bruit contrôlée
    internal_batch_size=2    # protection VRAM
)
